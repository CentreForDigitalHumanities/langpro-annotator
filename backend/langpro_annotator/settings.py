"""
Django settings for langpro_annotator project.
...
import os
from langpro_annotator.common_settings import *
...
WSGI_APPLICATION = 'langpro_annotator.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('PGDATABASE') or 'langpro_annotator',
        'USER': os.environ.get('PGUSER') or 'langpro_annotator',
        'PASSWORD': os.environ.get('PGPASSWORD') or 'langpro_annotator',
