...
Every test in this suite is a short, automated simulation of the interaction between a user and LangPro Annotator, written in Python. [Selenium][2] provides the programmable web browser interface while [pytest][1] provides administrative support in the form of configuration and fixtures.
...
$ pytest --base-address https://www.langpro_annotator.com/app/
```
